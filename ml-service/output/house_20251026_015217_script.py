...
# Simple Blender Script for modern villa
import bpy
...
# Save file
bpy.ops.wm.save_as_mainfile(filepath=r"./output\house_20251026_015217.blend")
print(f"House saved to: ./output\house_20251026_015217.blend")
