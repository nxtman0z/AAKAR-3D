...
# Simple Blender Script for traditional bungalow
import bpy
...
# Save file
bpy.ops.wm.save_as_mainfile(filepath=r"./output\house_20251026_015150.blend")
print(f"House saved to: ./output\house_20251026_015150.blend")
